var robotTemplates = [
  { name: 'fssfllspring',
    shortDescription: 'FSS FLL Spring Training Robot',
    longDescription:
      '<p>This robot matches the Unmodified FSS FLL Spring Training Robot.</p>' +
    longerDescription:
      '<h3>Dimensions</h3>' +
      '<ul>' +
      ...
      '<h3>Actuators</h3>' +
      '<ul>' +
        '<li>Port A : Not Used</li>' +
        '<li>Port B : Left Wheel</li>' +
        '<li>Port C : Right Wheel</li>' +
        '<li>Port D : Not Used</li>' +
      '</ul>' +
      '<h3>Sensors</h3>' +
      '<ul>' +
        '<li>Port 1 : Line Following Color Sensor</li>' +
        '<li>Port 2 : Not Used</li>' +
        '<li>Port 3 : Not Used</li>' +
        '<li>Port 4 : Not Used</li>' +
      '</ul>',
